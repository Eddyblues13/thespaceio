...
<body>
        ...
        <div class="container">
            <div class="row align-items-center">
                <div class="col-lg-6">
                    ...
                    <p class="lead mb-4">Leading the transformation of industry and society through artificial
                        intelligence, cloud computing, and strategic investments.</p>
                    <a href="#ai-investments" class="btn btn-light btn-lg">Explore AI Investments</a>
                </div>
                <div class="col-lg-6">
                    <img src="https://images.unsplash.com/photo-1633419461181-2ee8d0ac59c8?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=1000&q=80"
                        alt="Microsoft AI" class="img-fluid rounded shadow">
                </div>
            </div>
        </div>
    </section>
    ...
    <section id="about" class="py-5">
        <div class="container">
            ...
            <div class="row">
                <div class="col-lg-6">
                    <p class="mb-4">Microsoft Corporation is an American multinational technology company headquartered
                        in Redmond, Washington. Founded in 1975 by Bill Gates and Paul Allen, Microsoft develops,
                        manufactures, licenses, supports, and sells computer software, consumer electronics, personal
                        computers, and related services.</p>
                    <p class="mb-4">Under CEO Satya Nadella's leadership since 2014, Microsoft has transformed into a
                        cloud-first, AI-first company, with significant investments in artificial intelligence, cloud
                        computing, and strategic partnerships.</p>
                    <p>Microsoft's mission is to empower every person and every organization on the planet to achieve
                        more. The company is organized into three business segments: Productivity and Business
                        Processes, Intelligent Cloud, and More Personal Computing.</p>
                </div>
                <div class="col-lg-6">
                    <img src="https://images.unsplash.com/photo-1634942537034-2531766767d1?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=1000&q=80"
                        alt="Microsoft Campus" class="img-fluid rounded shadow">
                </div>
            </div>
        </div>
    </section>
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="card h-100 ai-product-card">
                        <div class="card-body">
                            ...
                            <p class="card-text">Comprehensive suite of AI services for developers and data scientists
                                to build, deploy, and manage AI applications.</p>
                            <ul>
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="card h-100 ai-product-card">
                        <div class="card-body">
                            ...
                            <p class="card-text">AI-powered assistants integrated across Microsoft's product suite to
                                enhance productivity and creativity.</p>
                            <ul>
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="card h-100 ai-product-card">
                        <div class="card-body">
                            ...
                            <p class="card-text">Provides access to OpenAI's powerful models through Azure's
                                enterprise-grade platform with added security and compliance features.</p>
                            <ul>
                                <li>GPT-4 Access</li>
    ...
    <section id="ai-investments" class="py-5 bg-light">
        <div class="container">
            ...
            <div class="row mb-5">
                <div class="col-lg-6">
                    <p>Microsoft has made significant strategic investments in AI companies and technologies,
                        positioning itself at the forefront of the AI revolution.</p>
                    <p>These investments reflect Microsoft's commitment to advancing AI capabilities while ensuring
                ...
                <div class="col-lg-4 col-md-6 mb-4">
                    <div class="card h-100 ai-investment-card">
                        <div class="card-body">
                            ...
                            <p class="card-text">Multi-billion dollar partnership including cloud credits, joint
                                development, and exclusive licensing agreements.</p>
                ...
                <div class="col-lg-4 col-md-6 mb-4">
                    <div class="card h-100 ai-investment-card">
                        <div class="card-body">
                            ...
                            <p class="card-text">Acquired for $19.7B to enhance Microsoft's healthcare AI capabilities
                                with conversational AI and ambient clinical intelligence.</p>
                ...
                <div class="col-lg-4 col-md-6 mb-4">
                    <div class="card h-100 ai-investment-card">
                        <div class="card-body">
                            ...
                            <p class="card-text">Acquired for $7.5B, now home to GitHub Copilot - the AI pair programmer
                                that suggests code in real-time.</p>
            ...
            <div class="row mt-5">
                ...
                <div class="col-lg-6">
                    ...
                    <p>Microsoft's strategic AI investments are driving significant revenue growth across its cloud and
                        productivity segments.</p>
                    ...
                    <div class="card mt-4">
                        <div class="card-body">
                            ...
                            <p>Microsoft expects AI services to contribute significantly to revenue growth, with
                                AI-related Azure services growing at over 100% annually.</p>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="col-lg-8 mx-auto">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <ul>
                                <li><strong>Azure AI Services:</strong> One of the fastest-growing segments with 100%+
                                    growth</li>
                                <li><strong>GitHub Copilot:</strong> Over 1 million paid subscribers within first year
                                </li>
                                <li><strong>Microsoft Cloud:</strong> $110+ billion annualized revenue run rate, heavily
                                    influenced by AI services</li>
                                <li><strong>Productivity & Business Processes:</strong> Enhanced by AI capabilities in
                                    Microsoft 365 and Dynamics 365</li>
                            </ul>
                            <p>Analysts project that AI could add $10-20 billion to Microsoft's annual revenue by 2025.
                            </p>
                        </div>
                    </div>
                </div>
            ...
            <div class="timeline">
                <div class="timeline-item left">
                    <div class="timeline-content">
                        <h5>2016</h5>
                        <p>Microsoft creates Microsoft AI and Research Group, combining over 5,000 computer scientists
                            and engineers focused on AI.</p>
                    </div>
                </div>
                ...
                <div class="timeline-item left">
                    <div class="timeline-content">
                        <h5>2019</h5>
                        <p>Invests $1B in OpenAI and becomes their exclusive cloud provider, beginning a strategic
                            partnership.</p>
                    </div>
                </div>
                <div class="timeline-item right">
                ...
                <div class="timeline-item right">
                    <div class="timeline-content">
                        <h5>2022</h5>
                        <p>Acquires Nuance Communications for $19.7B, significantly expanding healthcare AI
                            capabilities.</p>
                    </div>
                </div>
                <div class="timeline-item left">
                    <div class="timeline-content">
                        <h5>1995</h5>
                        <p>Announces multibillion-dollar extension of OpenAI partnership and launches Microsoft 365
                            Copilot.</p>
                    </div>
                </div>
            </div>
