            ...
            <div class="row align-items-center">
                <div class="col-lg-6">
                    <img src="https://huggingface.co/front/assets/huggingface_logo-noborder.svg" alt="Hugging Face"
                        class="company-logo mb-4" style="height: 80px;">
            ...
            <div class="row">
                <div class="col-lg-8">
                    <div class="content-card">
                        ...
                        <p>Hugging Face is the leading open-source platform for the machine learning community,
                            providing tools and infrastructure to build, train, and deploy AI models. Started as a
                            chatbot company, it pivoted to become the "GitHub of Machine Learning," creating the largest
                            repository of AI models, datasets, and applications.</p>

                        <p>The company's core product is the Hugging Face Hub, a platform where researchers and
                            developers can share, discover, and collaborate on AI models. With over 1 million models and
                            50,000 datasets, Hugging Face has become the central hub for the global AI community,
                            powering innovation across academia, startups, and enterprises.</p>

                        <img src="https://images.unsplash.com/photo-1551288049-bebda4e38f71?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=1470&q=80"
                            alt="AI Community Collaboration" class="img-fluid">

                        <h4 class="mt-4">Core Philosophy</h4>
                        <ul>
                            <li><strong>Democratize AI:</strong> Make state-of-the-art AI accessible to everyone</li>
                            <li><strong>Community-First:</strong> Build through collaboration and open-source principles
                            </li>
                            <li><strong>Interoperability:</strong> Create standards and tools that work across
                                frameworks</li>
                            <li><strong>Open Science:</strong> Promote transparency and reproducibility in AI research
                            </li>
                            <li><strong>Developer Experience:</strong> Build tools that make AI development easier and
                                faster</li>
                        </ul>
                    </div>
                </div>
                ...
                <div class="col-lg-4">
                    <div class="content-card">
                        ...
                        <div class="mb-4">
                            ...
                            <p>Former product manager who built Hugging Face from chatbot startup to AI platform leader
                            </p>
                        </div>
                        <div class="mb-4">
                    ...
                    <div class="content-card">
                        ...
                        <div class="d-flex align-items-center mb-3">
                            <img src="https://upload.wikimedia.org/wikipedia/commons/thumb/8/8f/Sequoia_Capital_logo.svg/1200px-Sequoia_Capital_logo.svg.png"
                                alt="Sequoia Capital"
                        ...
                        <div class="d-flex align-items-center mb-3">
                            <img src="https://upload.wikimedia.org/wikipedia/commons/thumb/8/8f/Lux_Capital_logo.svg/1200px-Lux_Capital_logo.svg.png"
                                alt="Lux Capital"
                                style="height: 30px; margin-right: 10px; background: white; padding: 5px; border-radius: 4px;">
                            <div>
                        ...
                        <div class="d-flex align-items-center mb-3">
                            <img src="https://upload.wikimedia.org/wikipedia/commons/thumb/a/a9/Coat_of_arms_of_Google.svg/1200px-Coat_of_arms_of_Google.svg.png"
                                alt="Google"
                                style="height: 30px; margin-right: 10px; background: white; padding: 5px; border-radius: 4px;">
                            <div>
                        ...
                        <div class="d-flex align-items-center">
                            <img src="https://upload.wikimedia.org/wikipedia/commons/thumb/8/8c/Amazon_Web_Services_Logo.svg/1200px-Amazon_Web_Services_Logo.svg.png"
            ...
            <div class="content-card mt-4">
                ...
                <div class="timeline">
                    <div class="timeline-item">
                        ...
                        <p>Hugging Face founded as a chatbot company creating AI-powered conversational agents for
                            teenagers.</p>
                    </div>
                    <div class="timeline-item">
                        <div class="timeline-date">2018</div>
                        <p>Pivoted to focus on open-source AI tools, releasing the Transformers library that would
                            become industry standard.</p>
                    </div>
                    <div class="timeline-item">
                    ...
                    <div class="timeline-item">
                        ...
                        <p>Raised $100M Series C funding at $2B valuation with participation from Sequoia and others.
                        </p>
                    </div>
                    <div class="timeline-item">
                    ...
                    <div class="timeline-item">
                        ...
                        <p>Platform reaches 1M+ models, 50K+ datasets, and becomes essential infrastructure for AI
                            development.</p>
                    </div>
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-lg-4 mb-4">
                    <div class="product-card">
                        <img src="https://images.unsplash.com/photo-1551288049-bebda4e38f71?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=1470&q=80"
                            alt="Hugging Face Hub">
                        <h4>Hugging Face Hub</h4>
                        <p>The central repository for AI models, datasets, and demos with over 1 million models. Enables
                            discovery, collaboration, and deployment of AI assets.</p>
                        <div class="mt-3">
                ...
                <div class="col-lg-4 mb-4">
                    <div class="product-card">
                        <img src="https://images.unsplash.com/photo-1677442136019-21780ecad995?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=1470&q=80"
                            alt="Transformers Library">
                        <h4>Transformers Library</h4>
                        <p>The industry-standard Python library for state-of-the-art machine learning, providing
                            thousands of pretrained models for various AI tasks.</p>
                        <div class="mt-3">
                ...
                <div class="col-lg-4 mb-4">
                    <div class="product-card">
                        ...
                        <h4>Spaces</h4>
                        <p>Platform for easily deploying, demoing, and discovering AI applications. Enables developers
                            to share their work and users to try AI models instantly.</p>
                        <div class="mt-3">
            ...
            <div class="row mt-4">
                <div class="col-lg-6 mb-4">
                    <div class="content-card">
                        ...
                        <ul>
                            <li><strong>Enterprise Hub:</strong> Private, secure platform for internal AI development
                            </li>
                ...
                <div class="row">
                    <div class="col-md-4 mb-4">
                        <div class="platform-feature text-center">
                            ...
                            <p>Git-like version control for machine learning models with full history and collaboration
                                features</p>
                        </div>
                    </div>
                    <div class="col-md-4 mb-4">
                        ...
                        <div class="mb-3">
                            ...
                            <div class="progress mb-2" style="height: 20px;">
                                <div class="progress-bar bg-success" role="progressbar" style="width: 95%;"
                                    aria-valuenow="95" aria-valuemin="0" aria-valuemax="100">1M+ Models</div>
                            </div>
                        </div>
                        ...
                        <div class="mb-3">
                            ...
                            <div class="progress mb-2" style="height: 20px;">
                                <div class="progress-bar bg-info" role="progressbar" style="width: 85%;"
                                    aria-valuenow="85" aria-valuemin="0" aria-valuemax="100">10,000+ Organizations</div>
                            </div>
                        </div>
                        ...
                        <div class="mb-3">
                            ...
                            <div class="progress mb-2" style="height: 20px;">
                                <div class="progress-bar bg-primary" role="progressbar" style="width: 75%;"
                                    aria-valuenow="75" aria-valuemin="0" aria-valuemax="100">5,000+ Enterprise Customers
                                </div>
                            </div>
                        </div>

                        <p class="mt-3"><strong>Network Effect:</strong> Each new model and dataset makes the platform
                            more valuable for all users.</p>
                    </div>
                </div>
                        ...
                        <div class="row">
                            <div class="col-md-3 mb-3 text-center">
                                <img src="https://upload.wikimedia.org/wikipedia/commons/thumb/2/2f/Google_2015_logo.svg/1200px-Google_2015_logo.svg.png"
                                    alt="Google" style="height: 40px; margin-bottom: 10px;">
                                <h6>Google Cloud</h6>
                            ...
                            <div class="col-md-3 mb-3 text-center">
                                <img src="https://upload.wikimedia.org/wikipedia/commons/thumb/f/fa/Microsoft_Azure.svg/1200px-Microsoft_Azure.svg.png"
                                    alt="Microsoft" style="height: 40px; margin-bottom: 10px;">
                                <h6>Microsoft Azure</h6>
                                <p class="small">Azure ML integration and enterprise deployment solutions</p>
                            </div>
                            <div class="col-md-3 mb-3 text-center">
                                <img src="https://upload.wikimedia.org/wikipedia/commons/thumb/8/8c/Amazon_Web_Services_Logo.svg/1200px-Amazon_Web_Services_Logo.svg.png"
                                    alt="AWS" style="height: 40px; margin-bottom: 10px;">
                                <h6>Amazon AWS</h6>
                                <p class="small">SageMaker integration and cloud infrastructure partnership</p>
                            </div>
                            <div class="col-md-3 mb-3 text-center">
                                <img src="https://upload.wikimedia.org/wikipedia/commons/thumb/3/3a/NVIDIA_logo.svg/1200px-NVIDIA_logo.svg.png"
                                    alt="NVIDIA" style="height: 40px; margin-bottom: 10px;">
                                <h6>NVIDIA</h6>
                        ...
                        <div class="mb-3">
                            ...
                            <div class="progress mb-2" style="height: 20px;">
                                <div class="progress-bar bg-success" role="progressbar" style="width: 60%;"
                                    aria-valuenow="60" aria-valuemin="0" aria-valuemax="100">Primary Revenue Source
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="mb-3">
                            ...
                            <div class="progress mb-2" style="height: 20px;">
                                <div class="progress-bar bg-info" role="progressbar" style="width: 25%;"
                                    aria-valuenow="25" aria-valuemin="0" aria-valuemax="100">Usage-Based Revenue</div>
                            </div>
                        </div>
                        ...
                        <div class="mb-3">
                            ...
                            <div class="progress mb-2" style="height: 20px;">
                                <div class="progress-bar bg-primary" role="progressbar" style="width: 10%;"
                                    aria-valuenow="10" aria-valuemin="0" aria-valuemax="100">Consulting & Support</div>
                            </div>
                        </div>
                        ...
                        <div class="mb-3">
                            ...
                            <div class="progress mb-2" style="height: 20px;">
                                <div class="progress-bar bg-warning text-dark" role="progressbar" style="width: 5%;"
                                    aria-valuenow="5" aria-valuemin="0" aria-valuemax="100">Strategic Partnerships</div>
                            </div>
                        </div>
                    </div>
                </div>
