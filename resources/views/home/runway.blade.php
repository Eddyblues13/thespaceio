...
<body>
    ...
    <section class="hero-section">
        <div class="container">
            <div class="row align-items-center">
                <div class="col-lg-6">
                    <h1 class="display-4 fw-bold mb-4">Next-generation <span class="gradient-text">generative
                            video</span> tools</h1>
                    <p class="lead mb-4">Runway is building the next generation of creative tools powered by artificial
                        intelligence. Our technology enables anyone to create professional-grade video content with
                ...
                <div class="col-lg-6">
                    <div class="video-showcase">
                        <img src="https://images.unsplash.com/photo-1635070041078-e363dbe005cb?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=1000&q=80"
                            alt="AI Video Generation" class="img-fluid">
                    </div>
                </div>
            </div>
        </div>
    ...
    <section id="about" class="py-5">
        <div class="container">
            ...
            <div class="row">
                <div class="col-lg-6">
                    <p class="mb-4">Runway is an American technology company that develops artificial intelligence
                        systems for content generation, with a focus on video and image creation. Founded in 2018 by
                        Cristóbal Valenzuela, Anastasis Germanidis, and Alejandro Matamala-Ortiz, Runway aims to make
                        advanced creative tools accessible to everyone.</p>
                    <p class="mb-4">The company's flagship product is a web-based platform that allows users to generate
                        and edit videos using text prompts and other AI-powered tools. Runway's technology has been used
                        in professional film production, including the Oscar-winning film "Everything Everywhere All at
                        Once."</p>
                    <p>Runway's mission is to reimagine content creation by building the next generation of creative
                        tools powered by artificial intelligence, making professional-grade video creation accessible to
                        everyone.</p>
                </div>
                <div class="col-lg-6">
                    <img src="https://images.unsplash.com/photo-1555949963-ff9fe0c870eb?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=1000&q=80"
                        alt="Runway Team" class="img-fluid rounded shadow">
                </div>
            </div>
        </div>
    </section>
            ...
            <div class="product-showcase">
                <div class="row">
                    <div class="col-lg-8 mx-auto text-center">
                        ...
                        <p class="lead">A complete toolkit for video creation, editing, and enhancement powered by
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="card h-100 ai-product-card">
                        <div class="card-body">
                            ...
                            <p class="card-text">Text-to-video generation that creates high-quality video clips from
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="card h-100 ai-product-card">
                        <div class="card-body">
                            ...
                            <p class="card-text">Suite of 30+ AI tools for video editing including object removal,
                                motion tracking, and background replacement.</p>
                            <ul>
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="card h-100 ai-product-card">
                        <div class="card-body">
                            ...
                            <p class="card-text">Collaborative workspace for teams to create, edit, and manage video
                                projects with AI assistance.</p>
                            <ul>
    ...
    <section id="ai-investments" class="py-5 bg-light">
        <div class="container">
            ...
            <div class="row mb-5">
                <div class="col-lg-6">
                    <p>Runway has secured significant funding from top-tier investors who recognize the transformative
                        potential of generative video technology in the creative industry.</p>
                    <p>The company's funding strategy focuses on advancing research in generative AI models while
                        building sustainable business models around creative tools.</p>
            ...
            <div class="row">
                <div class="col-lg-4 col-md-6 mb-4">
                    <div class="card h-100 ai-investment-card">
                        <div class="card-body">
                            ...
                            <p class="card-text">$50M extension round led by Google with participation from NVIDIA and
                                Salesforce.</p>
                ...
                <div class="col-lg-4 col-md-6 mb-4">
                    <div class="card h-100 ai-investment-card">
                        <div class="card-body">
                            <h4 class="card-title">Series C</h4>
                            <p class="card-text">$50M round co-led by Felicis and Coatue with participation from
                                Compound.</p>
                ...
                <div class="col-lg-4 col-md-6 mb-4">
                    <div class="card h-100 ai-investment-card">
                        <div class="card-body">
                            ...
                            <p class="card-text">$35M round led by Coatue with participation from Compound and Lux
                                Capital.</p>
            ...
            <div class="row align-items-center justify-content-center text-center">
                ...
                <div class="col-md-2 col-4 mb-4">
                    <img src="https://upload.wikimedia.org/wikipedia/commons/thumb/2/21/NVIDIA_logo.svg/1280px-NVIDIA_logo.svg.png"
                        alt="NVIDIA" class="img-fluid investor-logo">
                </div>
                <div class="col-md-2 col-4 mb-4">
                    <img src="https://upload.wikimedia.org/wikipedia/commons/thumb/f/f9/Salesforce_logo.svg/1280px-Salesforce_logo.svg.png"
                        alt="Salesforce" class="img-fluid investor-logo">
                </div>
                <div class="col-md-2 col-4 mb-4">
                    <img src="https://upload.wikimedia.org/wikipedia/commons/thumb/b/b1/Coatue_Management_logo.svg/1200px-Coatue_Management_logo.svg.png"
                        alt="Coatue" class="img-fluid investor-logo">
                </div>
                <div class="col-md-2 col-4 mb-4">
                    <img src="https://upload.wikimedia.org/wikipedia/commons/thumb/8/8d/Lux_Capital_logo.svg/1200px-Lux_Capital_logo.svg.png"
                        alt="Lux Capital" class="img-fluid investor-logo">
                </div>
            </div>
            ...
            <div class="row mt-5">
                ...
                <div class="col-lg-6">
                    ...
                    <p>The generative video market is experiencing explosive growth as AI capabilities advance and
                        creative professionals adopt these tools.</p>
                    ...
                    <div class="card mt-4">
                        <div class="card-body">
                            ...
                            <p>Runway is positioned as a leader in the generative video space, competing with companies
                                like OpenAI, Stability AI, and Adobe while focusing specifically on video generation.
                            </p>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-lg-8 mx-auto">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <p>Runway employs a multi-tiered business model targeting both individual creators and
                                enterprise clients:</p>
                            <ul>
                                <li><strong>Freemium Model:</strong> Free tier with limited credits to attract new users
                                </li>
                                <li><strong>Subscription Tiers:</strong> Individual and team plans with increased
                                    capabilities</li>
                                <li><strong>Enterprise Solutions:</strong> Custom pricing for large organizations and
                                    studios</li>
                                <li><strong>API Access:</strong> Developer access to Runway's AI models</li>
                            </ul>
                            <p>The company's revenue is primarily driven by subscription fees, with enterprise contracts
                                representing a growing segment.</p>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="timeline">
                <div class="timeline-item left">
                    <div class="timeline-content">
                        <h5>2018</h5>
                        <p>Runway founded by Cristóbal Valenzuela, Anastasis Germanidis, and Alejandro Matamala-Ortiz as
                            a research project at NYU.</p>
                    </div>
                </div>
                <div class="timeline-item right">
                    <div class="timeline-content">
                        <h5>2019</h5>
                        <p>Launches first product - a toolkit for creatives to use machine learning models in their
                            work. Raises $2M seed round.</p>
                    </div>
                </div>
                <div class="timeline-item left">
                    <div class="timeline-content">
                ...
                <div class="timeline-item right">
                    <div class="timeline-content">
                        <h5>2021</h5>
                        <p>Raises $35M Series B led by Coatue. Launches Gen-1, their first video-to-video generation
                            model.</p>
                    </div>
                </div>
                <div class="timeline-item left">
                    <div class="timeline-content">
                        <h5>2022</h5>
                        <p>Raises $50M Series C at $500M valuation. Technology used in Oscar-winning film "Everything
                ...
                <div class="timeline-item right">
                    <div class="timeline-content">
                        <h5>1995</h5>
                        <p>Launches Gen-2 text-to-video model. Raises $50M extension at $1.5B valuation with Google,
                            NVIDIA, and Salesforce.</p>
                    </div>
                </div>
            </div>
        </div>
