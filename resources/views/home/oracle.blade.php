            ...
            <div class="row align-items-center">
                <div class="col-lg-8">
                    <div class="d-flex align-items-center mb-4">
                        <img src="https://logos-world.net/wp-content/uploads/2020/09/Oracle-Logo.png" alt="Oracle" style="height: 80px; margin-right: 20px; filter: brightness(0) invert(1);">
                        <h1 class="hero-title oracle-red">Oracle Corporation <span class="badge bg-secondary">ORCL</span></h1>
                    </div>
                    <p class="hero-subtitle">Global leader in enterprise cloud computing and database software. Oracle provides integrated suites of applications plus secure, autonomous infrastructure in the Oracle Cloud.</p>
                    
                    <div class="stock-widget-large">
                        <div class="row align-items-center">
                            <div class="col-md-6">
                                <div class="stock-price-large">$118.42</div>
                                <div class="stock-change-large positive">+1.27% <i class="fas fa-arrow-up"></i> (+$1.48)</div>
            ...
            <div class="row">
                <div class="col-lg-8">
                    <div class="detail-card">
                        ...
                        <p>Oracle operates as a global provider of enterprise cloud computing and database software, focusing on:</p>
                        <ul>
                            <li><strong>Cloud Services & License Support:</strong> Cloud infrastructure, database management systems, and enterprise software solutions</li>
                            <li><strong>Cloud License & On-Premise License:</strong> Traditional software licenses and cloud application subscriptions</li>
                            <li><strong>Hardware:</strong> Server, storage, and networking solutions optimized for Oracle software</li>
                            <li><strong>Services:</strong> Consulting, implementation, and education services</li>
                        </ul>
                        <p>The company is aggressively transitioning from traditional on-premise software to cloud-based subscription models, with significant growth in Oracle Cloud Infrastructure (OCI).</p>
                    </div>
                </div>
            ...
            <div class="row mt-4">
                <div class="col-lg-6">
                    <div class="detail-card">
                        ...
                        <ul>
                            <li><strong>Database Dominance:</strong> Oracle Database maintains ~40% market share in relational databases</li>
                            <li><strong>Enterprise Relationships:</strong> Deep relationships with Fortune 500 companies and government agencies</li>
                            <li><strong>Integrated Stack:</strong> Complete stack from applications to infrastructure provides competitive moat</li>
                            <li><strong>Autonomous Database:</strong> Industry-leading self-driving database technology with strong security</li>
                            <li><strong>Cloud Infrastructure Growth:</strong> OCI gaining market share with superior price-performance vs. competitors</li>
                        </ul>
                    </div>
                </div>
                ...
                <div class="col-lg-6">
                    <div class="detail-card">
                        ...
                        <h3>Risk Factors</h3>
                        <ul>
                            <li><strong>Cloud Competition:</strong> Intense competition from AWS, Microsoft Azure, and Google Cloud</li>
                            <li><strong>Legacy Business Decline:</strong> On-premise license business facing secular decline</li>
                            <li><strong>Customer Transition:</strong> Challenges in migrating traditional customers to cloud solutions</li>
                            <li><strong>Acquisition Integration:</strong> Historical challenges integrating large acquisitions (Cerner, NetSuite)</li>
                            <li><strong>Regulatory Scrutiny:</strong> Increasing regulatory attention on cloud and data privacy practices</li>
                        </ul>
                    </div>
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-lg-6">
                    <div class="analysis-card">
                        ...
                        <p>Our AI models indicate Oracle presents moderate growth potential with strong cloud transition momentum offset by intense competition. The Cerner acquisition provides significant cross-selling opportunities but integration risks remain.</p>
                            ...
                            <div class="col-md-4">
                                ...
                                <div class="d-flex align-items-center my-2">
                                    <div class="progress flex-grow-1 me-2" style="height: 20px;">
                                        <div class="progress-bar bg-warning" role="progressbar" style="width: 65%;" aria-valuenow="65" aria-valuemin="0" aria-valuemax="100">65% Positive</div>
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-4">
                                ...
                                <div class="d-flex align-items-center my-2">
                                    <div class="progress flex-grow-1 me-2" style="height: 20px;">
                                        <div class="progress-bar bg-warning" role="progressbar" style="width: 58%;" aria-valuenow="58" aria-valuemin="0" aria-valuemax="100">58% Buy</div>
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-4">
                                ...
                                <div class="d-flex align-items-center my-2">
                                    <div class="progress flex-grow-1 me-2" style="height: 20px;">
                                        <div class="progress-bar bg-warning" role="progressbar" style="width: 76%;" aria-valuenow="76" aria-valuemin="0" aria-valuemax="100">76% Confident</div>
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                <div class="col-lg-12">
                    <div class="detail-card">
                        ...
                        <div class="mt-4">
                            ...
                            <p>Oracle completed the $28.3 billion acquisition of Cerner in June 2022, marking its largest acquisition ever. This move positions Oracle as a major player in the healthcare IT sector and provides significant cross-selling opportunities for Oracle's cloud infrastructure and applications.</p>
                            
                            <h5 class="oracle-red mt-4">Cloud Infrastructure Expansion</h5>
                            <p>Oracle continues rapid expansion of OCI data centers globally, with plans to operate 44 cloud regions by end of 1995. The company is gaining market share by focusing on price-performance advantages and specialized workloads like high-performance computing.</p>
                            
                            <h5 class="oracle-red mt-4">Partnership with Microsoft</h5>
                            <p>The Oracle-Microsoft Azure Interconnect partnership enables customers to run workloads across both clouds, addressing multi-cloud strategies while maintaining Oracle database performance and Azure integration.</p>
                            
                            <h5 class="oracle-red mt-4">Generative AI Initiatives</h5>
                            <p>Oracle has integrated generative AI capabilities across its cloud applications and database services, including AI-powered features in Fusion Applications and Autonomous Database with built-in machine learning.</p>
                        </div>
                    </div>
                </div>
            </div>
