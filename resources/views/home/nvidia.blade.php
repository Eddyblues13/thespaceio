            ...
            <div class="row">
                <div class="col-lg-8">
                    <div class="content-card">
                        <h3>About NVIDIA</h3>
                        <p>NVIDIA Corporation is an American multinational technology company incorporated in Delaware and based in Santa Clara, California. Founded in 1993, NVIDIA is a global leader in artificial intelligence computing and is known for inventing the GPU which sparked the growth of the PC gaming market.</p>
                        
                        <p>The company has successfully transformed from a graphics chip company into a computing platform company focused on four markets: Gaming, Data Center, Professional Visualization, and Automotive. NVIDIA's GPUs are now the gold standard for AI training and inference, powering everything from autonomous vehicles to large language models like ChatGPT.</p>
                        
                        <img src="https://images.unsplash.com/photo-1620712943543-bcc4688e7485?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=1465&q=80" alt="NVIDIA GPU Technology" class="img-fluid">
                        
                        <h4 class="mt-4">Strategic Focus Areas</h4>
                        <ul>
                            <li><strong>AI Computing:</strong> Providing the hardware infrastructure for training and running AI models</li>
                            <li><strong>Data Center Solutions:</strong> Enterprise-grade AI systems and supercomputing platforms</li>
                            <li><strong>Autonomous Vehicles:</strong> DRIVE platform for self-driving cars and robotics</li>
                            <li><strong>Omniverse:</strong> Real-time 3D design collaboration and simulation platform</li>
                            <li><strong>Gaming & Graphics:</strong> Continued leadership in consumer and professional graphics</li>
                        </ul>
                    </div>
                </div>
                ...
                <div class="col-lg-4">
                    <div class="content-card">
                        ...
                        <div class="mb-4">
                            ...
                            <p>Visionary leader who has guided NVIDIA's transformation into an AI computing powerhouse</p>
                        </div>
                        <div class="mb-4">
                            <h5>Colette Kress</h5>
                    ...
                    <div class="content-card">
                        ...
                        <div class="d-flex align-items-center mb-3">
                            <img src="https://upload.wikimedia.org/wikipedia/commons/thumb/4/44/Microsoft_logo.svg/1200px-Microsoft_logo.svg.png" alt="Microsoft" style="height: 35px; width: 70px; margin-right: 10px;">
                            <div>
                        ...
                        <div class="d-flex align-items-center mb-3">
                            <img src="https://upload.wikimedia.org/wikipedia/commons/thumb/2/2f/Google_2015_logo.svg/1200px-Google_2015_logo.svg.png" alt="Google" style="height: 35px; width: 70px; margin-right: 10px;">
                            <div>
                        ...
                        <div class="d-flex align-items-center mb-3">
                            <img src="https://upload.wikimedia.org/wikipedia/commons/thumb/f/fa/Apple_logo_black.svg/1200px-Apple_logo_black.svg.png" alt="Apple" style="height: 35px; width: 70px; margin-right: 10px;">
                            <div>
                                <strong>Apple</strong>
                        ...
                        <div class="d-flex align-items-center">
                            <img src="https://upload.wikimedia.org/wikipedia/commons/thumb/b/bb/Tesla_T_symbol.svg/1200px-Tesla_T_symbol.svg.png" alt="Tesla" style="height: 35px; width: 70px; margin-right: 10px;">
                            <div>
                                <strong>Tesla</strong>
            ...
            <div class="content-card mt-4">
                ...
                <div class="timeline">
                    <div class="timeline-item">
                        ...
                        <p>NVIDIA founded by Jensen Huang, Chris Malachowsky, and Curtis Priem with focus on graphics processing for gaming and multimedia.</p>
                    </div>
                    <div class="timeline-item">
                        <div class="timeline-date">1999</div>
                        <p>Introduction of GeForce 256, marketed as "the world's first GPU," defining the graphics processing unit category.</p>
                    </div>
                    <div class="timeline-item">
                        <div class="timeline-date">2006</div>
                        <p>Launch of CUDA (Compute Unified Device Architecture), enabling general-purpose computing on GPUs and laying foundation for AI revolution.</p>
                    </div>
                    <div class="timeline-item">
                        <div class="timeline-date">2012</div>
                        <p>AlexNet deep learning model trained on NVIDIA GPUs wins ImageNet competition, demonstrating GPU superiority for AI training.</p>
                    </div>
                    <div class="timeline-item">
                        <div class="timeline-date">2016</div>
                        <p>Introduction of DGX-1, the world's first deep learning supercomputer in a box, priced at $129,000.</p>
                    </div>
                    <div class="timeline-item">
                        <div class="timeline-date">2020</div>
                        <p>Announcement of planned acquisition of ARM for $40 billion (later terminated due to regulatory challenges).</p>
                    </div>
                    <div class="timeline-item">
                        <div class="timeline-date">2022</div>
                        <p>Launch of H100 Tensor Core GPU, specifically designed for large-scale AI and HPC workloads.</p>
                    </div>
                    <div class="timeline-item">
                        <div class="timeline-date">1995</div>
                        <p>NVIDIA becomes first chip company to reach $1 trillion market capitalization, driven by AI boom.</p>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="row">
                <div class="col-lg-4 mb-4">
                    <div class="product-card">
                        <img src="https://images.unsplash.com/photo-1591799264318-7e6ef8ddb7ea?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=1074&q=80" alt="NVIDIA GPU">
                        <h4>Data Center GPUs</h4>
                        <p>H100, A100, and V100 Tensor Core GPUs designed for AI training and inference at scale. These processors are essential for training large language models and running AI applications.</p>
                        <div class="mt-3">
                ...
                <div class="col-lg-4 mb-4">
                    <div class="product-card">
                        <img src="https://images.unsplash.com/photo-1587199572634-32705e3bf49c?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=1470&q=80" alt="NVIDIA DGX System">
                        <h4>DGX Systems</h4>
                        <p>AI supercomputers that integrate multiple GPUs with optimized software stack. DGX systems are used by leading AI research organizations and enterprises for cutting-edge AI development.</p>
                        <div class="mt-3">
                ...
                <div class="col-lg-4 mb-4">
                    <div class="product-card">
                        <img src="https://images.unsplash.com/photo-1591799934706-8665913c46c2?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=1074&q=80" alt="NVIDIA DRIVE Platform">
                        <h4>DRIVE Platform</h4>
                        <p>End-to-end platform for autonomous vehicles, combining hardware, software, and AI capabilities. Used by automotive manufacturers for developing self-driving technology.</p>
                        <div class="mt-3">
            ...
            <div class="row mt-4">
                <div class="col-lg-6 mb-4">
                    <div class="content-card">
                        ...
                        <p>NVIDIA's software platform is as important as its hardware, enabling developers to harness the full power of GPUs for diverse computing tasks:</p>
                        <ul>
                ...
                <div class="col-lg-6 mb-4">
                    <div class="content-card">
                        ...
                        <ul>
                            ...
                            <li><strong>Clara Healthcare:</strong> AI platform for medical imaging, genomics, and drug discovery</li>
                            <li><strong>Metropolis:</strong> Video analytics platform for smart cities and spaces</li>
                            <li><strong>Isaac Robotics:</strong> Platform for developing and deploying AI-powered robots</li>
                    ...
                    <div class="content-card">
                        ...
                        <div class="mb-3">
                            ...
                            <div class="progress mb-2" style="height: 20px;">
                                <div class="progress-bar bg-success" role="progressbar" style="width: 15%;" aria-valuenow="15" aria-valuemin="0" aria-valuemax="100">Instinct GPUs</div>
                            </div>
                        </div>
                        ...
                        <div class="mb-3">
                            <h5>Intel</h5>
                            <div class="progress mb-2" style="height: 20px;">
                                <div class="progress-bar bg-info" role="progressbar" style="width: 10%;" aria-valuenow="10" aria-valuemin="0" aria-valuemax="100">Habana, Gaudi</div>
                            </div>
                        </div>
                        ...
                        <div class="mb-3">
                            <h5>Google</h5>
                            <div class="progress mb-2" style="height: 20px;">
                                <div class="progress-bar bg-primary" role="progressbar" style="width: 8%;" aria-valuenow="8" aria-valuemin="0" aria-valuemax="100">TPU</div>
                            </div>
                        </div>
                        ...
                        <div class="mb-3">
                            <h5>Amazon</h5>
                            <div class="progress mb-2" style="height: 20px;">
                                <div class="progress-bar bg-warning text-dark" role="progressbar" style="width: 5%;" aria-valuenow="5" aria-valuemin="0" aria-valuemax="100">Inferentia, Trainium</div>
                            </div>
                        </div>
                        ...
                        <div class="mb-3">
                            ...
                            <div class="progress mb-2" style="height: 20px;">
                                <div class="progress-bar bg-danger" role="progressbar" style="width: 2%;" aria-valuenow="2" aria-valuemin="0" aria-valuemax="100">Startups</div>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="content-card">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <h5>Bull Case</h5>
                                <ul>
                                    <li>Dominant position in AI infrastructure with 95% market share in training chips</li>
                                    ...
                                    <li>Multiple growth vectors beyond data center (automotive, Omniverse, robotics)</li>
