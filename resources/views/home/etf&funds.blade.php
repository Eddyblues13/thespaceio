...
<body>
    ...
    <section class="content-section">
        <div class="container">
            ...
            <div class="row justify-content-center">
                <div class="col-lg-10">
                    <div class="fund-card">
                        <p>The TheSpace AI ETF & Funds are designed to give investors broad, diversified, and intelligent exposure to the rapidly expanding artificial intelligence ecosystem.</p>
                        <p>Through a combination of public market ETFs, private equity funds, and venture allocations, TheSpace empowers investors to participate in the full growth cycle of AI — from early innovation to global adoption.</p>
                        <p>Whether you are an individual investor, a corporate entity, or an institutional fund, TheSpace makes it possible to own a stake in the world's most advanced AI-driven enterprises.</p>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="row">
                <div class="col-lg-8 mx-auto">
                    <div class="fund-card">
                        ...
                        <p class="fund-subtitle">Tracks and invests in leading publicly traded companies driving the AI revolution</p>
                        
                        <p>The TheSpace Artificial Intelligence Exchange-Traded Fund (AIETF) tracks and invests in leading publicly traded companies driving the AI revolution across technology, data, automation, and robotics.</p>
                        ...
                        <p class="mt-4">Each company in the ETF represents a different dimension of the AI economy — ensuring investors benefit from both growth and stability.</p>
            ...
            <div class="row">
                <div class="col-lg-8 mx-auto">
                    <div class="fund-card">
                        ...
                        <p class="fund-subtitle">Access to private and pre-IPO AI startups shaping the next decade of innovation</p>
                        
                        <p>The TheSpace AI Growth Fund (AIGF) gives investors access to the private and pre-IPO AI startups that are shaping the next decade of innovation.</p>
                        ...
                        <p class="mt-4">The AIGF identifies startups before they reach mass adoption — offering early-stage exposure with exponential upside potential.</p>
            ...
            <div class="row">
                <div class="col-lg-8 mx-auto">
                    <div class="fund-card">
                        ...
                        <p>This specialized fund targets the core infrastructure that enables AI to scale — including data centers, semiconductor manufacturing, AI energy systems, and neural computing networks.</p>
                        
                        <p>It is built for large investors seeking long-term stability with exposure to the "picks and shovels" of the AI revolution.</p>
            ...
            <div class="row">
                <div class="col-lg-8 mx-auto">
                    <div class="fund-card">
                        ...
                        <p>For investors seeking a single-entry solution, TheSpace offers the Multi-Asset AI Portfolio, combining:</p>
                        ...
                        <p class="mt-4">This creates a balanced, high-growth, low-volatility structure designed for long-term wealth building and compounding returns.</p>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="row justify-content-center">
                <div class="col-lg-10">
                    <div class="fund-card text-center">
                        ...
                        <p>We combine the power of financial strategy, data analysis, and AI forecasting models to maximize profitability and minimize risk.</p>
                        <p>Our team continuously monitors market trends, startup valuations, and technological shifts to ensure investors are always ahead of the curve.</p>
                        ...
                        <div class="mt-4 p-4" style="background-color: rgba(0, 82, 163, 0.1); border-radius: 10px;">
                            ...
                            <p class="mb-2">TheSpace bridges innovation and investment — allowing you to profit from every layer of the AI transformation.</p>
    ...
    <section class="cta-section">
        <div class="container">
            ...
            <p class="cta-subtitle">Join the revolution and position your portfolio for the AI-driven future with TheSpace's diversified funds.</p>
            ...
            <div class="row">
                ...
                <div class="col-lg-3 mb-4">
                    ...
                    <div class="footer-links">
                        ...
                        <a href="https://www.TheSpace.ai" target="_blank"><i class="fas fa-globe me-2"></i>www.TheSpace.ai</a>
                    </div>
                </div>
            </div>
