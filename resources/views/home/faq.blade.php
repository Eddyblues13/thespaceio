...
<body>
    ...
    <section class="faq-hero">
        <div class="container">
            ...
            <p class="hero-subtitle">Find answers to common questions about TheSpace, our investment strategies, and how you can benefit from the AI revolution.</p>
        </div>
    </section>
                    ...
                    <div class="accordion faq-accordion" id="faqAccordion">
                        ...
                        <div class="accordion-item">
                            ...
                            <div id="collapseOne" class="accordion-collapse collapse show" data-bs-parent="#faqAccordion">
                                <div class="accordion-body">
                                    <p>TheSpace is a global investment company specializing in Artificial Intelligence (AI) assets and technologies.</p>
                                    <p>We invest in the world's leading AI corporations, high-growth startups, and infrastructure firms — giving our investors diversified exposure to the most powerful technology revolution of our time.</p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="accordion-item">
                            ...
                            <div id="collapseTwo" class="accordion-collapse collapse" data-bs-parent="#faqAccordion">
                                <div class="accordion-body">
                                    ...
                                    <ul>
                                        <li><strong>Public AI ETF</strong> (investing in global giants like Nvidia, Microsoft, Google, and Tesla)</li>
                                        <li><strong>Private AI Growth Fund</strong> (funding early-stage innovators like OpenAI, Anthropic, and Stability AI)</li>
                                        <li><strong>AI Infrastructure Fund</strong> (investing in data centers, chips, and quantum computing systems)</li>
                                    </ul>
                                    <p>Investors contribute capital to TheSpace, which is then allocated across these portfolios. As the AI industry grows, TheSpace's portfolio value rises — and investors earn returns from those profits.</p>
                                </div>
                            </div>
                        </div>
                            ...
                            <div id="collapseThree" class="accordion-collapse collapse" data-bs-parent="#faqAccordion">
                                <div class="accordion-body">
                                    ...
                                    <ul>
                                        ...
                                        <li>Institutional and corporate investors (partnership or large-scale funding options available)</li>
                                    </ul>
                                    <p>TheSpace welcomes investors who want long-term exposure to the booming AI sector.</p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="accordion-item">
                            <h2 class="accordion-header" id="headingFour">
                                <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapseFour">
                                    <i class="fas fa-star me-2"></i> What makes TheSpace different from other investment companies?
                                </button>
                            </h2>
                            <div id="collapseFour" class="accordion-collapse collapse" data-bs-parent="#faqAccordion">
                                <div class="accordion-body">
                                    <p>Unlike traditional funds that focus on a single company or narrow sector, TheSpace gives you a stake in the entire AI ecosystem — from tech giants to emerging startups.</p>
                                    <p>We combine financial expertise with cutting-edge AI market analytics to identify high-potential growth areas before they hit the mainstream.</p>
                        ...
                        <div class="accordion-item">
                            ...
                            <div id="collapseFive" class="accordion-collapse collapse" data-bs-parent="#faqAccordion">
                                <div class="accordion-body">
                                    ...
                                    <ol>
                                        <li><strong>Capital Appreciation:</strong> As AI companies grow, the value of TheSpace's portfolio increases.</li>
                                        <li><strong>Revenue Sharing:</strong> Profits earned by AI companies and partnerships are shared proportionally.</li>
                                        <li><strong>IPO & Exit Gains:</strong> Early-stage startups that go public or are acquired generate high returns.</li>
                                        <li><strong>Performance Bonuses:</strong> Investors in higher tiers gain extra profit-sharing and loyalty bonuses.</li>
                                    </ol>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="accordion-item">
                            <h2 class="accordion-header" id="headingSix">
                                <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapseSix">
                                    <i class="fas fa-layer-group me-2"></i> What are the investment tiers and minimum amounts?
                                </button>
                            </h2>
                        ...
                        <div class="accordion-item">
                            ...
                            <div id="collapseSeven" class="accordion-collapse collapse" data-bs-parent="#faqAccordion">
                                <div class="accordion-body">
                                    <p>TheSpace applies diversified risk management, investing across multiple AI sectors, regions, and market levels.</p>
                                    <p>We continuously monitor portfolio performance and use advanced AI analytics to predict and adjust for market shifts.</p>
                                    <p>While all investments carry some risk, TheSpace's diversified model greatly reduces volatility compared to single-company investing.</p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="accordion-item">
                            ...
                            <div id="collapseEight" class="accordion-collapse collapse" data-bs-parent="#faqAccordion">
                                <div class="accordion-body">
                                    <p>Returns are distributed quarterly or annually, depending on the investment tier.</p>
                                    <p>Investors receive clear performance reports, portfolio updates, and reinvestment options.</p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="accordion-item">
                            ...
                            <div id="collapseNine" class="accordion-collapse collapse" data-bs-parent="#faqAccordion">
                                <div class="accordion-body">
                                    <p>Yes. Investors may choose to reinvest part or all of their earnings into the next investment cycle to compound long-term returns.</p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="accordion-item">
                            <h2 class="accordion-header" id="headingTen">
                                <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapseTen">
                                    <i class="fas fa-money-bill-wave me-2"></i> Does TheSpace have a management or performance fee?
                                </button>
                            </h2>
                        ...
                        <div class="accordion-item">
                            <h2 class="accordion-header" id="headingTwelve">
                                <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapseTwelve">
                                    <i class="fas fa-industry me-2"></i> What industries does TheSpace's AI portfolio cover?
                                </button>
                            </h2>
                        ...
                        <div class="accordion-item">
                            <h2 class="accordion-header" id="headingThirteen">
                                <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapseThirteen">
                                    <i class="fas fa-chart-bar me-2"></i> What is the projected return on investment (ROI)?
                                </button>
                            </h2>
                            <div id="collapseThirteen" class="accordion-collapse collapse" data-bs-parent="#faqAccordion">
                                <div class="accordion-body">
                                    <p>Returns vary depending on market conditions, fund type, and investor tier. However, TheSpace's annual ROI projections are as follows:</p>
                                    <div class="roi-table">
                                        <table class="table table-striped">
                                            <thead>
                                                <tr>
                        ...
                        <div class="accordion-item">
                            <h2 class="accordion-header" id="headingFourteen">
                                <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapseFourteen">
                                    <i class="fas fa-handshake me-2"></i> Can companies or institutions partner with TheSpace?
                                </button>
                            </h2>
                            <div id="collapseFourteen" class="accordion-collapse collapse" data-bs-parent="#faqAccordion">
                                <div class="accordion-body">
                                    <p>Yes. TheSpace actively collaborates with corporations, startups, and financial institutions seeking AI co-development or funding opportunities.</p>
                                    <p>Partnerships can include joint ventures, infrastructure co-investments, or innovation funding.</p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="accordion-item">
                            ...
                            <div id="collapseFifteen" class="accordion-collapse collapse" data-bs-parent="#faqAccordion">
                                <div class="accordion-body">
                                    ...
                                    <p>Our team will then provide onboarding, portfolio updates, and personalized investment insights.</p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="accordion-item">
                            <h2 class="accordion-header" id="headingSixteen">
                                <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapseSixteen">
                                    <i class="fas fa-tools me-2"></i> Is TheSpace involved in building AI technologies itself?
                                </button>
                            </h2>
                            <div id="collapseSixteen" class="accordion-collapse collapse" data-bs-parent="#faqAccordion">
                                <div class="accordion-body">
                                    <p>Yes. Beyond funding AI companies, TheSpace also develops in-house AI tools, data analytics systems, and digital assets, further boosting the company's profitability and technical edge.</p>
                                </div>
                            </div>
                        </div>
                            ...
                            <div id="collapseSeventeen" class="accordion-collapse collapse" data-bs-parent="#faqAccordion">
                                <div class="accordion-body">
                                    ...
                                    <ul>
                                        ...
                                        <li>Private and infrastructure funds follow fixed holding periods (usually 6–12 months) before exit or reinvestment options are available.</li>
                                    </ul>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="accordion-item">
                            ...
                            <div id="collapseEighteen" class="accordion-collapse collapse" data-bs-parent="#faqAccordion">
                                <div class="accordion-body">
                                    <p>TheSpace operates globally with financial and technology hubs across North America, Europe, and Asia, ensuring diversified market access and innovation sourcing.</p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="accordion-item">
                            ...
                            <div id="collapseNineteen" class="accordion-collapse collapse" data-bs-parent="#faqAccordion">
                                <div class="accordion-body">
                                    <p>To build the world's most trusted AI investment ecosystem — connecting investors, innovators, and industries under one intelligent financial network.</p>
                                    <p>Our long-term vision is to make AI ownership accessible to everyone, creating wealth while accelerating human progress.</p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="accordion-item">
                            ...
                            <div id="collapseTwenty" class="accordion-collapse collapse" data-bs-parent="#faqAccordion">
                                <div class="accordion-body">
                                    <p>Visit <a href="https://www.TheSpace.ai" target="_blank">www.TheSpace.ai</a> or email <a href="mailto:invest@TheSpace.ai">invest@TheSpace.ai</a> for direct inquiries, partnership discussions, or investor support.</p>
                                </div>
                            </div>
                        </div>
                    </div>
    ...
    <section class="cta-section">
        <div class="container">
            ...
            <p class="cta-subtitle">Join thousands of investors who are already benefiting from the AI revolution with TheSpace. Start with as little as $10,000 and watch your portfolio grow.</p>
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-4 mb-4">
                    ...
                    <p>Building the world's most trusted AI investment ecosystem — connecting investors, innovators, and industries under one intelligent financial network.</p>
                    <div class="mt-3">
                ...
                <div class="col-lg-3 mb-4">
                    ...
                    <div class="footer-links">
                        ...
                        <a href="https://www.Thspace.io" target="_blank"><i class="fas fa-globe me-2"></i>www.Thspace.io</a>
                    </div>
                </div>
            </div>
