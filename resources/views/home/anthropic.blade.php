    ...
    <section class="hero-section">
        <div class="container">
            <div class="row align-items-center">
                <div class="col-lg-6">
                    <img src="https://upload.wikimedia.org/wikipedia/commons/thumb/6/6a/Anthropic_logo.svg/1200px-Anthropic_logo.svg.png" alt="Anthropic" class="company-logo mb-4" style="height: 80px;">
                ...
                <div class="col-lg-4">
                    ...
                    <div class="content-card">
                        ...
                        <div class="d-flex align-items-center mb-3">
                            <img src="https://upload.wikimedia.org/wikipedia/commons/thumb/a/a9/Amazon_logo.svg/1200px-Amazon_logo.svg.png" alt="Amazon" style="height: 30px; margin-right: 10px;">
                            <div>
                        ...
                        <div class="d-flex align-items-center mb-3">
                            <img src="https://upload.wikimedia.org/wikipedia/commons/thumb/5/51/Google_Cloud_logo.svg/1200px-Google_Cloud_logo.svg.png" alt="Google" style="height: 30px; margin-right: 10px;">
                            <div>
                        ...
                        <div class="d-flex align-items-center mb-3">
                            <img src="https://upload.wikimedia.org/wikipedia/commons/thumb/4/4e/SK_Telecom_logo.svg/1200px-SK_Telecom_logo.svg.png" alt="SK Telecom" style="height: 30px; margin-right: 10px; background: white; padding: 5px; border-radius: 4px;">
                            <div>
    ...
    <section class="py-5" style="background: rgba(26, 77, 46, 0.3);">
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="col-lg-4 mb-4">
                    <div class="product-card">
                        <img src="https://images.unsplash.com/photo-1677442135337-6b5f6deacec9?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=1470&q=80" alt="Constitutional AI">
