...
<body>
    ...
    <section id="about" class="py-5">
        <div class="container">
            ...
            <div class="row">
                <div class="col-lg-6">
                    <p class="mb-4">Mistral AI is a French artificial intelligence company founded in April 2023 by alumni from Google's DeepMind and Meta. The company is focused on developing open-weight generative AI models that are efficient, multilingual, and accessible.</p>
    ...
    <section class="py-5 bg-light">
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="col-md-3 col-sm-6">
                    <div class="stats-card card">
                        <div class="stats-number">2023</div>
                        <p>Founded</p>
                    </div>
                </div>
            </div>
    ...
    <footer>
        <div class="container">
            ...
            <hr class="mt-4 mb-4">
            <div class="text-center">
                <p>© 2023 Mistral AI. All rights reserved. | Paris, France</p>
            </div>
        </div>
    </footer>
