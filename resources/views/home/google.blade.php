        ...
        <div class="container">
            <div class="row align-items-center">
                <div class="col-lg-8">
                    ...
                    <p class="hero-subtitle">A global technology leader focused on organizing the world's information and making it universally accessible and useful. Alphabet's main business is Google, along with growing businesses in cloud computing, hardware, and other bets.</p>
                    
                    <div class="stock-widget-large">
                        <div class="row align-items-center">
                            <div class="col-md-6">
                                <div class="stock-price-large">$142.65</div>
                                <div class="stock-change-large negative">-0.85% <i class="fas fa-arrow-down"></i> (-$1.22)</div>
            ...
            <div class="row">
                <div class="col-lg-8">
                    <div class="detail-card">
                        ...
                        <ul>
                            <li><strong>Google Services:</strong> Search, advertising, Android, Chrome, Google Maps, Google Play, YouTube, and hardware products</li>
                            <li><strong>Google Cloud:</strong> Infrastructure and data analytics platforms, collaboration tools, and other enterprise services</li>
                            <li><strong>Other Bets:</strong> Early-stage businesses including Waymo (autonomous vehicles), Verily (life sciences), and more</li>
                        </ul>
                        <p>The company generates the majority of its revenue from advertising across its platforms, while strategically investing in cloud computing and moonshot projects for long-term growth.</p>
                    </div>
                </div>
                ...
                <div class="col-lg-6">
                    <div class="detail-card">
                        ...
                        <ul>
                            ...
                            <li><strong>Data Network Effects:</strong> Vast user data improves AI and targeting capabilities</li>
                            <li><strong>Ecosystem Lock-in:</strong> Android, Chrome, Gmail, and YouTube create powerful ecosystem</li>
                            <li><strong>AI Leadership:</strong> Industry-leading AI research and implementation across products</li>
                            <li><strong>Scale & Infrastructure:</strong> Global data center network and technical infrastructure</li>
                        </ul>
                    </div>
                </div>
                ...
                <div class="col-lg-6">
                    <div class="detail-card">
                        ...
                        <ul>
                            ...
                            <li><strong>AI Competition:</strong> Increasing competition from Microsoft/OpenAI and others</li>
                            <li><strong>Privacy Changes:</strong> Browser and mobile OS privacy features impact ad targeting</li>
            ...
            <div class="row">
                <div class="col-lg-6">
                    <div class="analysis-card">
                        ...
                        <p>Our AI models indicate Alphabet presents strong long-term growth potential despite near-term headwinds. The company's AI leadership, diversified revenue streams, and massive cash flow generation support a BUY recommendation.</p>
                            ...
                            <div class="col-md-4">
                                ...
                                <div class="d-flex align-items-center my-2">
                                    <div class="progress flex-grow-1 me-2" style="height: 20px;">
                                        <div class="progress-bar bg-success" role="progressbar" style="width: 82%;" aria-valuenow="82" aria-valuemin="0" aria-valuemax="100">82% Positive</div>
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-4">
                                ...
                                <div class="d-flex align-items-center my-2">
                                    <div class="progress flex-grow-1 me-2" style="height: 20px;">
                                        <div class="progress-bar bg-success" role="progressbar" style="width: 85%;" aria-valuenow="85" aria-valuemin="0" aria-valuemax="100">85% Buy</div>
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-4">
                                ...
                                <div class="d-flex align-items-center my-2">
                                    <div class="progress flex-grow-1 me-2" style="height: 20px;">
                                        <div class="progress-bar bg-success" role="progressbar" style="width: 89%;" aria-valuenow="89" aria-valuemin="0" aria-valuemax="100">89% Confident</div>
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                <div class="col-lg-12">
                    <div class="detail-card">
                        ...
                        <div class="mt-4">
                            ...
                            <p>Google has aggressively integrated AI across its product portfolio and launched Bard, its conversational AI service, to compete with ChatGPT. The company is leveraging its vast data and AI research capabilities to maintain leadership in generative AI.</p>
                            
                            <h5 class="google-blue mt-4">Antitrust Litigation</h5>
                            <p>Google faces multiple antitrust lawsuits globally, including the U.S. Department of Justice case focusing on search dominance and advertising practices. Outcomes could significantly impact business practices and market position.</p>
                            
                            <h5 class="google-blue mt-4">Cloud Growth Acceleration</h5>
                            <p>Google Cloud continues to gain market share, reporting 37% year-over-year growth. The division is focusing on AI-powered solutions and industry-specific offerings to differentiate from AWS and Azure.</p>
                            
                            <h5 class="google-blue mt-4">Cost Optimization Initiatives</h5>
                            <p>Alphabet announced workforce reductions and cost optimization measures in 1995, reflecting a shift toward greater efficiency while maintaining strategic investments in AI and cloud computing.</p>
                        </div>
                    </div>
                </div>
            </div>
