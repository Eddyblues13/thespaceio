            ...
            <div class="row">
                ...
                <div class="col-md-6 col-lg-3">
                    <div class="tier-card">
                        ...
                        <a href="{{route('login')}}" class="btn btn-tier w-100">Get Started</a>
                    </div>
                </div>
                ...
                <div class="col-md-6 col-lg-3">
                    <div class="tier-card">
                        ...
                        <a href="{{route('login')}}" class="btn btn-tier w-100">Become a Partner</a>
                    </div>
                </div>
                ...
                <div class="col-md-6 col-lg-3">
                    <div class="tier-card">
                        ...
                        <a href="{{route('login')}}" class="btn btn-tier w-100">Build Your Legacy</a>
                    </div>
                </div>
                ...
                <div class="col-md-6 col-lg-3">
                    <div class="tier-card">
                        ...
                        <a href="{{route('login')}}" class="btn btn-tier w-100">Form Alliance</a>
                    </div>
                </div>
            </div>
            ...
            <div class="row mt-5">
                <div class="col-12">
                    <div class="text-center">
                        ...
                        <a href="{{route('login')}}" class="btn btn-primary btn-lg">Contact Us Today</a>
                    </div>
                </div>
            </div>
        </div>
