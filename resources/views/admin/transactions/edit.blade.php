        ...
        <div class="page-inner">
            ...
            <div class="page-header">
                <div class="d-flex justify-content-between align-items-center flex-wrap">
                    <h4 class="page-title text-dark"><i class="fas fa-edit mr-2"></i>Edit Transaction</h4>
                            ...
                            <form action="{{ route('admin.transactions.update', $transaction) }}" method="POST">
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="form-control @error('type') is-invalid @enderror" id="type" name="type" required>
                                        ...
                                        <option value="dividend" {{ old('type', $transaction->type) == 'dividend' ? 'selected' : '' }}>Dividend</option>
                                    </select>
                                    @error('type')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control @error('description') is-invalid @enderror" id="description" 
                                              name="description" rows="3">{{ old('description', $transaction->description) }}</textarea>
                                    @error('description')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control @error('method') is-invalid @enderror" id="method" name="method" 
                                           value="{{ old('method', $transaction->method) }}" required>
                                    @error('method')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
