        ...
        <div class="row">
            ...
            <div class="col-md-9 col-lg-10 main-content">
                ...
                <div class="dashboard-card">
                    ...
                    <p class="card-subtitle">Choose your preferred deposit method based on the amount you wish to
                        deposit</p>

                    <div class="amount-input-container">
                        <div class="amount-label">Deposit Amount (USD)</div>
                        <input type="number" class="amount-input" id="depositAmount" placeholder="Enter amount in USD"
                            min="1" step="0.01">
                    </div>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-6">
                        <div class="payment-method-card" id="cryptoMethodCard">
                            ...
                            <p class="payment-method-description">
                                For deposits of any amount, enjoy fast, secure, and direct cryptocurrency transfer using
                                Bitcoin.
                            </p>
                    ...
                    <div class="col-lg-6">
                        <div class="payment-method-card" id="wireMethodCard">
                            ...
                            <div class="form-check">
                                <input class="form-check-input" type="radio" name="paymentMethod" id="wireMethod"
                                    value="wire">
                ...
                <div class="dashboard-card crypto-payment-section" id="cryptoPaymentSection">
                    ...
                    <div class="crypto-note">
                        ...
                        Please send exactly the amount specified above to this Bitcoin address. Transactions may take
                        10-30 minutes to confirm on the blockchain.
                    </div>
                    ...
                    <div class="mt-4">
                        ...
                        <div class="alert alert-warning" role="alert">
                            ...
                            Waiting for payment confirmation. Your deposit will be credited once we receive 3
                            confirmations on the Bitcoin network.
                        </div>
                    </div>
                </div>
