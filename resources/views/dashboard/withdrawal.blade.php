                            ...
                            <form id="withdrawalForm">
                                ...
                                <div id="crypto-form" class="withdrawal-form">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="number" class="form-control" id="cryptoAmount" placeholder="0.00" min="50" step="0.01" max="12450">
                                    ...
                                    <button type="button" class="btn-withdraw" id="cryptoSubmit">Request Withdrawal</button>
                                </div>
                                ...
                                <div id="bank-form" class="withdrawal-form" style="display: none;">
                                    ...
                                    <div class="mb-3">
                                        <label class="form-label">Withdrawal Amount (USD)</label>
                                        <input type="number" class="form-control" placeholder="0.00" min="25" step="0.01" max="12450">
                                ...
                                <div id="wire-form" class="withdrawal-form" style="display: none;">
                                    ...
                                    <div class="mb-3">
                                        <label class="form-label">Withdrawal Amount (USD)</label>
                                        <input type="number" class="form-control" placeholder="0.00" min="100" step="0.01" max="12450">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                <input type="text" class="form-control mb-2" placeholder="Account Holder Name">
                                            </div>
                                            <div class="col-md-6">
                                                <input type="text" class="form-control mb-2" placeholder="Account Number">
                                            </div>
                                            <div class="col-md-6">
                                                <input type="text" class="form-control mb-2" placeholder="Routing Number">
                                            </div>
                                            <div class="col-md-6">
                                ...
                                <div id="cashapp-form" class="withdrawal-form" style="display: none;">
                                    <div class="mb-3">
                                        ...
                                        <input type="text" class="form-control" placeholder="Your Cash App $username" value="$johndoe123">
                                    </div>
                                    
                                    <div class="mb-3">
                                        <label class="form-label">Withdrawal Amount (USD)</label>
                                        <input type="number" class="form-control" placeholder="0.00" min="10" step="0.01" max="12450">
                            ...
                            <div class="security-verification">
                                ...
                                <div class="verification-step">
                                    ...
                                    <div>
                                        ...
                                        <div class="mt-2">
                                            <input type="text" class="form-control" placeholder="Enter verification code" style="max-width: 200px;">
                                ...
                                <div class="verification-step">
                                    ...
                                    <div>
                                        ...
                                        <div class="mt-2">
                                            <input type="text" class="form-control" placeholder="6-digit code" style="max-width: 200px;">
                                        </div>
                                    </div>
                                </div>
