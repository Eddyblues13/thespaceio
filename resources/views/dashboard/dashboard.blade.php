                        ...
                        <div class="guidelines-content" id="guidelinesContent">
                            ...
                            <div class="guideline-item">
                                ...
                                <p class="guideline-text">
                                    Prior to initiating any deposit, it is strongly advised that you request the
                                    assistance of an Account Manager if you don't have one.
                                    Your assigned Account Manager will provide personalized guidance throughout the
                                    deposit and investment process, ensuring compliance with all necessary procedures.
                                </p>
                            </div>
                            ...
                            <div class="guideline-item">
                                ...
                                <p class="guideline-text">
                                    We offer two convenient deposit methods to accommodate different investor
                                    preferences: Direct Deposit and Installment Payment.
                                </p>
                                ...
                                <div class="deposit-methods">
                                    ...
                                    <div class="method-card">
                                        ...
                                        <p class="method-description">
                                            A Direct Deposit involves transferring the entire investment amount in a
                                            single transaction.
                                            Once the deposit is confirmed, your investment will be activated
                                            immediately, and returns will commence according to the terms of your
                                    ...
                                    <div class="method-card">
                                        ...
                                        <p class="method-description">
                                            The Installment Payment option is designed for investors who intend to begin
                                            with a specific investment amount but do not currently have the full capital
                                            available.
                                            For example, if you plan to start with $50,000 but do not have the complete
                                            funds at the moment, you may choose to make payments in smaller portions
                                ...
                                <div class="key-terms">
                                    ...
                                    <ul class="key-terms-list">
                                        <li>You may complete your installment payments in up to four (3) transactions.
                                        </li>
                                        <li>Your investment will officially commence after the total target amount has
                                            been fully deposited.</li>
                                        <li>Following your first installment, you will begin receiving company bonuses,
                                            which are withdrawable to your registered bank wallet or wallet.</li>
                                    </ul>
                                </div>
                            </div>
                            ...
                            <div class="action-buttons-section">
                                ...
                                <div class="action-buttons-container">
                                    <button class="action-button manager-button top-button" id="requestManagerBtn">
                                        ...
                                        <a href="accountmanager3"> Request Account Manager</a>
                                    </button>
                                    <div class="bottom-buttons">
                                        <a href="directdeposit" class="action-button direct-deposit-button">
                                            <i class="fas fa-money-bill-wave"></i>
                                            Direct Deposit
                                        </a>
                                        <button class="action-button installment-button" id="installmentBtn">
                                            <i class="fas fa-calendar-alt"></i>
                                            <a href="installmentalpayment">Installment Payment</a>
                                        </button>
                                    </div>
                                </div>
                            </div>
