...
Route::prefix('user')->middleware('user')->group(function () {
    ...
    Route::get('/investment', [DashboardController::class, 'investment'])->name('dashboard.investment');
    ...
    // Investments
    Route::get('/investment', [InvestmentController::class, 'index'])->name('dashboard.investment');
    ...
    // Transactions
    Route::get('/transactionssss', [TransactionController::class, 'index'])->name('transactions');
